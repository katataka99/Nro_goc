    ...
    public void login(String username, String password) {
        ...
        if (this.player == null) {
            ...
            try {
                ...
                this.uu = username;
                this.pp = password;
                pl = SQLHandle.login(this, al);
                if (pl != null && this.userId > 0) {
                    Player existingPlayer = Client.gI().getPlayerByUser(this.userId);
                    if (existingPlayer != null && existingPlayer.getSession() != null && existingPlayer.getSession() != this) {
                ...
                if (pl != null) {
                    ...
                    Logger.log("[" + TimeUtil.getCurrHour() + ":" + TimeUtil.getCurrMin() + "] - Player Login: " + this.player.name + ": " + (System.currentTimeMillis() - st) + " ms\n");
