...
public class ItemTimeService {
    ...
    public void sendAllItemTime(Player player) {
        ...
        if (player.itemTime.thuocMoIpana) {
            sendItemTime(player, 9068, (int) ((TIME_ITEM - (System.currentTimeMillis() - player.itemTime.lastTimethuocMo)) / 1000));
        }
        if (player.itemTime.thuocMoIpana1) {
            sendItemTime(player, 9068, (int) ((TIME_MAY_DO - (System.currentTimeMillis() - player.itemTime.lastTimethuocMo1)) / 1000));
        }
        if (player.itemTime.isCoBonLa) {
            sendItemTime(player, 13618, (int) ((TIME_MAY_DO2 - (System.currentTimeMillis() - player.itemTime.lastTimeCoBonLa)) / 1000));
        }
        if (player.itemTime.isUseKhoBauX2) {
            sendItemTime(player, 12834, (int) ((TIME_MAY_DO2 - (System.currentTimeMillis() - player.itemTime.lastTimeUseKhoBauX2)) / 1000));
        }
