...
public class TransactionService implements Runnable {
    ...
    private static final int TIME_DELAY_TRADE = 3000;
    ...
    public void controller(Player pl, Message msg) {
        try {
            if (pl.pvp != null) {
                Service.gI().sendThongBao(pl, "Đang giao đấu không thể.");
                return;
            }
            ...
            if (Service.gI().getCurrLevel(pl) < 5) {
                Service.gI().sendThongBao(pl, "Bạn cần đạt cấp độ Chiến binh cao cấp để giao dịch!");
                return;
            }
            ...
            switch (action) {
                ...
                case ACCEPT_TRADE:
                    ...
                    if (plMap != null && plMap.isPl()) {
                        ...
                        if (Service.gI().getCurrLevel(plMap) < 5) {
                            Service.gI().sendThongBao(pl, "Đối phương chưa đạt cấp Chiến binh cao cấp!");
                            return;
                        }
