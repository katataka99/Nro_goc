        ...
        try {
            ...
            switch (bossID) {
                ...
                case BossID.TAUPAYPAY -> {
                    return new TauPayPay(pl, BossID.TAUPAYPAY, BossesData.TAUPAYPAY);
                }
                case BossID.TAUPAYPAY_BOMONG -> {
                    return new TauPayPay(pl, BossID.TAUPAYPAY_BOMONG, BossesData.TAUPAYPAY_BOMONG);
                }
                case BossID.YAJIRO -> {
