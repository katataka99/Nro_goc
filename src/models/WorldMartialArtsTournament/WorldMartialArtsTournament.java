...
public final class WorldMartialArtsTournament implements Runnable {
    ...
    public void finish() {
        try {
            ...
            if (plWin != null) {
                // ✔ Nhận 10 triệu vàng
                plWin.inventory.gold += 1_000_000;
                Service.gI().sendThongBao(plWin, "Bạn vừa nhận thưởng 1.000.000 vàng");

                // ✔ Nhận 10 ngọc xanh
                plWin.inventory.gem += 2;
                Service.gI().sendThongBao(plWin, "Bạn vừa nhận thưởng 2 ngọc");

                Service.gI().sendMoney(plWin);

                // ❌ Bỏ dòng tặng vật phẩm ID 457
                // Service.gI().dropAndPickItem(plWin, 457, 100);
            }
            ...
            if (plLose != null && plLose.zone != null
                    && plLose.zone.map.mapId != plLose.gender + 21 && plLose.thongBaoThua) {
