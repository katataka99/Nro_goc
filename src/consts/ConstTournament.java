...
public class ConstTournament {
    ...
    public static final int[] minTournamentPower = {0, 1500000, 15000000, 150000000, 1500000000};
    public static final int[] tournamentPower = {1500000, 15000000, 150000000, 1500000000, 0};
