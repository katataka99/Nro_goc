...
public class ConstNpc {
    ...
    public static final String HUONG_DAN_BLACK_BALL_WAR = "Mỗi ngày từ 20h đến 21h các hành tinh có Ngọc Rồng Sao Đen sẽ xảy ra 1 cuộc đại chiến\n"
            ...
            + "Các phần thưởng như sau\b1 sao đen: +15% sức đánh cho toàn bang\b2 sao đen: +20% HP và KI tối đa cho toàn bang\b"
            + "3 sao đen: Mỗi giờ nhận 10 hạt đậu thần cấp 10 cho toàn bang\b4 sao đen: Mỗi giờ 1 viên ngọc rồng 5 sao cho toàn bang\b"
            + "5 sao đen: Mỗi giờ 3 đá nâng cấp ngẫu nhiên cho toàn bang\b6 sao đen: 1 triệu vàng cho toàn bang\b7 sao đen: 10 ngọc cho toàn bang";
    ...
    public static final byte CHI_CHI = 82;
    public static final byte MYUU = 83;
    public static final byte RUONG_SUU_TAP = 84;
    public static final byte QUAY_HANG_CA_ROT = 85;
    ...
    public static final int MENU_GIAM_GIA = 31052009;
    public static final int MENU_DOI_CA_ROT = 32052009;
    //index quy lão kamê
    ...
    public static final int SHENRON_1_3 = 504;
    public static final int SHENRON_2 = 505;
    public static final int SHENRON_3 = 506;
    ...
    public static final int XUONG_SHENRON = 201020033;
    ...
    public static final int NAP_VANG = 504;
     ...
     public static final int RUT_XU = 505;
    ...
    public static final int MENU_BANH_TET = 251004;

    public static final int MENU_BANH_TET_2 = 251005;

    public static final int MENU_BANH_CHUNG = 251006;

    public static final int MENU_BANH_CHUNG_2 = 251007;

    public static final int ĐỔI_PHIẾU_BÉ_NGOAN = 22154236;

    public static final int MAIL_BOX = 22154237;

    public static final int CONFIRM_REMOVE_ALL_ITEM_MAIL_BOX = 22154238;

    public static final int MENU_SINHLE = 251004;

    public static final int MENU_SINHLE_2 = 251005;

    public static final int MENU_SINHLE_XIN = 251006;

    public static final int MENU_SINHLE_XIN_2 = 251007;

    public static final int MENU_SINHLE_BANH_DAY = 251008;

    public static final int MENU_SINHLE_BANH_DAY_2 = 251009;

    public static final int MENU_SINHLE_BANH_CHUNG = 251010;

    public static final int MENU_SINHLE_BANH_CHUNG_2 = 251011;

    public static final int MTV = 251012;
