...
public class SystemMetrics {
    ...
    public static String ToString() {
        ...
        String string = ("|4|Used Memory: " + formatMemory(usedMemory, totalMemory) + "\n"
                + "|5|RAM Usage Percentage: " + formatPercentage(ramUsagePercentage) + "\n"
                + "|6|CPU Usage Percentage: " + formatPercentage(cpuUsagePercentage) + "\n"
                + "|7|Heap Used Memory: " + formatMemory(heapUsedMemory, heapMaxMemory) + "\n"
                + "|8|Heap Usage Percentage: " + formatPercentage(heapUsagePercentage));
        return string;
    }
}
