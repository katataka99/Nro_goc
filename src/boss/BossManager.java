...
import boss.boss_manifest.Baby.Baby;
import boss.boss_manifest.Baby.BabyMonKeyYellow;
import boss.boss_manifest.BossNew.AnTrom;
import boss.boss_manifest.BossNew.Odo;
...
import boss.boss_manifest.Cooler.Chiller;
import boss.boss_manifest.Cumber.Cumber;
import boss.boss_manifest.LunarNewYearEvent.BeNa;
import boss.boss_manifest.ThoDauBacDaiKa.ThoDauBacDaiKa;
...
//        this.createBoss(BossID.SOI,10);
        this.createBoss(BossID.GOLDEN_FRIEZA);
        this.createBoss(BossID.O_DO_2,20);
        this.createBoss(BossID.AN_TROM,30);
...
//        this.createBoss (BossID.THO_DAU_BAC_DAI_KA, 30);
    }
...
//                    new ThuyTinh();
                ...
                case BossID.CUMBER ->
                    new Cumber();
                case BossID. THO_DAU_BAC_DAI_KA ->
                    new ThoDauBacDaiKa();
                case BossID.AN_TROM ->
                        new AnTrom();
                case BossID.O_DO_2 ->
