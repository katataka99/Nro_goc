package boss.boss_manifest.BossRongNhi;
...
import utils.Util;
import static boss.BossType.HM;
...
public class RongNhi1Sao extends Boss {
    ...
    public RongNhi1Sao() throws Exception {
        super(HM, BossID.RONG_1_SAO, true, false, BossesData.RONG_1_SAO);
    }
    ...
    public void reward(Player plKill) {
        ...
        if (Util.isTrue(90, 100)) {
            ...
            ItemMap nhan = new ItemMap(this.zone, 1820, 1, this.location.x + Util.nextInt(-15, 15),
                    this.zone.map.yPhysicInTop(this.location.x, this.location.y - 24), plKill.id);
            nhan.options.add(new Item.ItemOption(30, 0));
            Service.gI().dropItemMap(this.zone, nhan);
        }
