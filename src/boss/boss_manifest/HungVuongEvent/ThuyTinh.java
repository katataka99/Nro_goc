    ...
    public void afk() {
        if (playerReward.isPl() && !isReward && this.zone != null) {
            if (Util.isTrue(5, 100)) {
                ItemMap ctrang = new ItemMap(this.zone, 1827, 1, this.location.x,
                        this.zone.map.yPhysicInTop(this.location.x,
                                this.location.y - 24),
                        playerReward.id);
                ctrang.options.add(new Item.ItemOption(50, 27));
                ctrang.options.add(new Item.ItemOption(10, 15));
                ctrang.options.add(new Item.ItemOption(77, 22));
                ctrang.options.add(new Item.ItemOption(103, 22));
                ctrang.options.add(new Item.ItemOption(83, 0));
                ctrang.options.add(new Item.ItemOption(14, 10));
                ctrang.options.add(new Item.ItemOption(93, Util.nextInt(1, 15)));
                Service.gI().dropItemMap(this.zone, ctrang);
            } else {
                ItemMap it = new ItemMap(this.zone, 1807, 1, this.location.x,
                        this.zone.map.yPhysicInTop(this.location.x,
                                this.location.y - 24),
                        playerReward.id);
                it.options.add(new Item.ItemOption(50, 17));
                it.options.add(new Item.ItemOption(14, 11));
