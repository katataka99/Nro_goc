    ...
    public void afk() {
        if (playerReward.isPl() && !isReward && this.zone != null) {
            if (Util.isTrue(5, 100)) {
                ItemMap ctang = new ItemMap(this.zone, 1826, 1, this.location.x,
                        this.zone.map.yPhysicInTop(this.location.x,
                                this.location.y - 24),
                        playerReward.id);
                ctang.options.add(new Item.ItemOption(50, 22));
                ctang.options.add(new Item.ItemOption(94, 15));
                ctang.options.add(new Item.ItemOption(77, 27));
                ctang.options.add(new Item.ItemOption(103, 22));
                ctang.options.add(new Item.ItemOption(83, 0));
                ctang.options.add(new Item.ItemOption(108, 12));
                if (Util.isTrue(1, 15)) {
                    ctang.options.add(new Item.ItemOption(116, 0));
                }
                ctang.options.add(new Item.ItemOption(154, 0));
                ctang.options.add(new Item.ItemOption(93, Util.nextInt(1, 15)));
                Service.gI().dropItemMap(this.zone, ctang);
            } else {
                ItemMap it = new ItemMap(this.zone, 1806, 1, this.location.x,
                        this.zone.map.yPhysicInTop(this.location.x,
                                this.location.y - 24),
                        playerReward.id);
                it.options.add(new Item.ItemOption(77, 17));
                it.options.add(new Item.ItemOption(108, 10));
                it.options.add(new Item.ItemOption(93, 3));
