...
public class BossID {
    ...
    public static final int THO_DAU_BAC_DAI_KA = -44;
    ...
    //========================TET EVENT========================
    public static final int BE_NA = -374;
    ...
    public static final int TAUPAYPAY_BOMONG = -400;
    //======================HANH TINH NGUC TU========================
    public static final int CUMBER = -366;

    //======================RONG NHI========================
    public static final int RONG_1_SAO = -367;
    public static final int RONG_2_SAO = -368;
    public static final int RONG_3_SAO = -369;
    public static final int RONG_4_SAO = -370;
    public static final int RONG_5_SAO = -371;
    public static final int RONG_6_SAO = -372;
    public static final int RONG_7_SAO = -373;
    public static final int CHILLER = -374;
    public static final int BABY = -375;
    public static final int BABY_MONKEY = 376;
    
    public static final int AN_TROM = -3972;
    public static final int SOI = -3793;
    public static final int O_DO_2 = -3974;
    public static final int Virus = -9999;
}
